...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    title: 'Unisex Obsidian Black',
    slug: 'unisex-obsidian-black',
    subtitle: 'Stealth Black Matte Acoustic Finish',
    description: 'Sleek obsidian black finish delivering punchy sub-bass, HD mic clarity, and all-day battery life.',
    story: 'Engineered for understated everyday style and dependable sound.',
    craftsmanship_details: 'Matte stealth black casing, Environmental Noise Cancellation, 32-hour battery.',
    hsn_code: '85183000',
    gst_percentage: 18,
    ...
    is_trending: false,
    images: [
      { id: 'img-unisex-black', url: '/images/earbuds-black.png', alt_text: 'Unisex Obsidian Black', is_primary: true, order: 1 }
    ],
    variants: [
      { id: 'var-uk-2', sku: 'EC-UNI-BLK', name: 'Obsidian Black', material: 'Matte Polymer', color: '#111111', price: 1499, stock_quantity: 50, is_available: true }
    ],
    avg_rating: 4.7,
    review_count: 59,
    reviews: [],
  ...
  },
  {
    ...
    title: 'Unisex Ceramic White',
    slug: 'unisex-ceramic-white',
    subtitle: 'Porcelain White Universal Fit Edition',
    description: 'Clean porcelain white earpieces with high dynamic audio response and featherlight comfort.',
    story: 'Pure white minimalist design engineered for seamless wireless connectivity and daily enjoyment.',
    craftsmanship_details: 'Polished white polymer casing, Bluetooth 5.4, Fast USB-C charging.',
    hsn_code: '85183000',
    gst_percentage: 18,
    ...
    is_trending: false,
    images: [
      { id: 'img-unisex-white', url: '/images/earbuds-white.png', alt_text: 'Unisex Ceramic White', is_primary: true, order: 1 }
    ],
    variants: [
      { id: 'var-uk-3', sku: 'EC-UNI-WHT', name: 'Ceramic White', material: 'Polished Polymer', color: '#FFFFFF', price: 1499, stock_quantity: 45, is_available: true }
    ],
    avg_rating: 4.9,
    review_count: 81,
    reviews: [],
