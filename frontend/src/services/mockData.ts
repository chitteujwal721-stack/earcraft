...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    craftsmanship_details: 'Ultra-lightweight polymer wing, dual mic noise suppression, 30-hour playback.',
    hsn_code: '85183000',
    gst_percentage: 18,
  ...
  {
    id: 'prod-golden-crafted-knot',
    title: 'Golden Crafted Knot',
    slug: 'golden-crafted-knot',
    subtitle: 'Intertwined 24K Gold Infinity Knot Acoustic Edition',
    description: 'Featuring precision 24K gold-plated infinity knot acoustic casing and high-fidelity sound stage output with 10mm dynamic drivers.',
    story: 'Intertwined 24K gold craftsmanship designed to accent your personal style while surrounding you in rich acoustic harmony.',
    craftsmanship_details: '24K Gold infinity knot charm attachment, IPX5 water resistance, Qi wireless charging support.',
    hsn_code: '85183000',
    gst_percentage: 18,
  ...
  },
  {
    ...
    description: 'Inspired by aerodynamic kinetics, the Golden Fly features bespoke 24K gold-plated winged acoustic geometry and high-fidelity sound stage output with 10mm dynamic drivers.',
    story: 'Sculptured with precision and finished in lustrous 24K gold for lightweight luxury and soaring acoustics.',
    craftsmanship_details: 'Aerodynamic 24K gold wing casing, IPX5 water resistance, low-latency gaming mode, Qi wireless charging.',
    hsn_code: '85183000',
    gst_percentage: 18,
...
export const mockSiteSettings: SiteSettings = {
  ...
  contact_phone: '+91 8591754505',
  address: 'EarCraft Acoustic Labs, Tech Plaza, Mumbai',
